...
class EventsRecorder(metaclass=SingletonMeta):
    ...
    def __init__(
        ...
        self.default_events_path = os.path.join('/home/flerb/Documents/eventsRecord','records.json')
    ...
    def replay(self, event_type: str=None, speed_factor: float = 11.0, min_move_distance: float = 50) -> None:
